<div class="row">
	<div class="small-12 columns">
		<p>The site layout is based on a 12 column grid. The grid itself expands and contracts based on the user's screen size, eventually stacking the columns vertically as the screen size gets smaller. Go ahead, drag your window nice and narrow and see how it responds!</p>
	</div>
</div>
